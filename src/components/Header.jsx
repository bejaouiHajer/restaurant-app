...
const Header = () => {
  ...
  return (
    <header className="fixed z-50 px-16  w-screen  p-6 ">
          ...
          <div className="relative">
            ...
            {isMenu && (
              <motion.div
                ...
                className="top-12 right-0 w-40 flex flex-col  bg-gray-50 shadow-xl rounded-lg absolute"
              >
                {user && user.email === "bjaouihejer3@gmail.com" && (
                  <Link to={"/createItem"}>
      ...
      {/* mobile */}
      <div className="flex items-center justify-between md:hidden p-3 px-4 md:p-6 md:px-16">
        <div className="relative flex items-center justify-center">
          <MdShoppingBasket className="text-textColor text-2xl " />
          <div className="flex items-center justify-center absolute -top-2 -right-2 w-5 h-5 rounded-full bg-cartNumBg">
            <p className="text-xs text-white font-semibold">2</p>
        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p
                className="m-2 p-2 shadow-md rounded-md flex items-center gap-3 justify-center bg-gray-300 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base"
                onClick={logout}
              >
                logout <MdLogout />
              </p>
